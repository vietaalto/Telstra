...
ex = Experiment('refined_extra_trees')
...
def my_config():
    ...
    aggregateparams = {"loc_agg_prior_weight":3.0,
                       "event_aggregates_noise_sigma":0.012,
                       "resource_aggregates_noise_sigma": 0.0}
    include = []
    exclude = []
...
@ex.automain
def ret(series, n_folds, clfparams, featureparams, aggregateparams, refineparams, include, exclude,
